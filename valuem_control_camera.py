...
cap = cv2.VideoCapture(0) #захват объекта (видео) object capture (video)
...
while True:
    ...
    lmList = []
    #захват пальцев руки для изменения громкости grabbing the fingers of the hand to change the volume 
    ...
    #фиксирует изменение положения пальцев fixes the change in the position of the fingers 
    if lmList != []:
